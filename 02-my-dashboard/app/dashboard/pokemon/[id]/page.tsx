...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    try {
        ...
        return {
            ...
            description: 'Occaecat enim labore laborum sint pariatur ex nostrud Lorem sint id sint ipsum exercitation eiusmod. Adipisicing id proident ipsum non. Eu incididunt est sunt veniam Lorem enim qui. Amet Lorem velit quis sit cupidatat est ullamco eiusmod ad Lorem ipsum.'
        }
    }
